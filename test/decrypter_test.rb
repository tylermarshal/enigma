...
class DecrypterTest < Minitest::Test
  ...
  def test_it_exists
    decrypter = Decrypter.new(")&8N0'BV(-JNu!A@)9Xdu,3d>", 12345)
  ...
  def test_decrypt_message_a_place
    ...
    assert_equal ["t", "&", "8", "N", " ", "'", "B", "V", "s", "-", "J", "N", "e", "!", "A", "@", "t", "9", "X", "d", "e", ",", "3", "d", "."], decrypter.decrypt_message_a_place
  end
  ...
  def test_decrypt_message_b_place
    ...
    assert_equal [")", "h", "8", "N", "0", "i", "B", "V", "(", "o", "J", "N", "u", "c", "A", "@", ")", " ", "X", "d", "u", "n", "3", "d", ">"], decrypter.decrypt_message_b_place
  end
  ...
  def test_decrypt_message_c_place
    ...
    assert_equal [")", "&", "i", "N", "0", "'", "s", "V", "(", "-", " ", "N", "u", "!", "r", "@", ")", "9", ".", "d", "u", ",", "d", "d", ">"], decrypter.decrypt_message_c_place
  end
